...
import de.co.derakhshan.imagepickerlib.util.FileUriUtils
import de.co.derakhshan.imagepickerlib.util.FileUtil
import de.co.derakhshan.imagepickerlib.util.ImageUtil
import java.io.File
        ...
        object : AsyncTask<File, Void, File>() {
            ...
            override fun onPostExecute(file: File?) {
                ...
                if (file != null) {
                    ...
                    // Post Error
                    setError(de.co.derakhshan.imagepickerlib.R.string.error_failed_to_compress_image)
                }
            }
        }.execute(file)
    }
